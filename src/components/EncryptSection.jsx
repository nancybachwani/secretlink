...
const EncryptSection = () => {
    ...
    return (
        <div className="flex flex-col bg-[#151c24] rounded-md p-3 min-[510px]:p-5">
            <textarea 
                className="scroll text-md min-[510px]:text-lg bg-[#151c24] rounded-md border-2 border-[#313131] focus:border-[#616161] focus:outline-none p-3 mb-2 w-full"
                type="text" 
                name="text"
            ...
            <textarea 
                className="scroll text-md min-[510px]:text-lg bg-[#151c24] rounded-md border-2 border-[#313131] focus:border-[#616161] focus:outline-none p-3 my-2 w-full"
                type="text" 
                name="text" 
            ...
            <div className='flex flex-col min-[600px]:flex-row justify-between items-center w-full mt-3'>
                <div className='flex items-center'>
                    <span className='text-[#ff0083] pr-1'>
                ...
                <button 
                    ...
                    className="text-lg hover:text-black hover:bg-[#ff0083] font-semibold border-2 border-[#ff0083] ease-in duration-500 uppercase rounded-md p-2 mt-3 min-[600px]:mt-0"
                    type="submit"
                >
